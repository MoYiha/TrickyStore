...
Installer, service, native payload, scripts, policy, metadata ve integrity kayıtlarından oluşan tam KernelSU/APatch/Magisk modülünü kurar. Android 12-17, ARM64 ve x86 64 desteklenir. Üçü de tam WebUI desteği sunar; Magisk'te WebUI, modül Action düğmesinden bağımsız WebUI host uygulaması üzerinden açılır ([Magisk Desteği](Magisk.md) dökümantasyonuna bakın). Recovery yolu durdurulur.
