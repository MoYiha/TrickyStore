...
Instala el módulo completo KernelSU/APatch/Magisk con service, native payload, scripts, policy, metadata e integrity records. Soporta Android 12-17, ARM64 y x86 64; los tres ofrecen soporte WebUI completo, en Magisk la WebUI se abre desde el botón Action del módulo mediante la app anfitriona WebUI independiente (consulte [Soporte para Magisk](Magisk.md)). La instalación por recovery se rechaza.
