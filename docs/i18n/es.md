...
Se requieren Java 21, SDK API 37, NDK 27.3.13750724, CMake 3.22.1, Rust estable, targets Android ARM64/x86 64, Cargo NDK y submodules. Deben pasar checks Kotlin/Android, Rust fmt/clippy/tests y unit tests.
