...
يثبت full KernelSU/APatch/Magisk module على Android 12-17 ARM64/x86 64. تدعم البيئات الثلاث واجهة WebUI بالكامل، وعلى Magisk تُفتح WebUI من زر Action الخاص بالوحدة عبر تطبيق مضيف WebUI المستقل (راجع [دعم Magisk](Magisk.md)). يتم رفض مسارات التثبيت عبر recovery.
