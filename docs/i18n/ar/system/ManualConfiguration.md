...
* **`global_telephony_mode`**: ملف علامة فارغ. عند وجوده تُطبق تجاوزات الهاتف على جميع التطبيقات المستهدفة؛ وإلا فعلى الأهداف المحددة صراحة فقط.
* **`global_attestation_mode`**: ملف علامة فارغ. عند وجوده تُطبق معرفات التصديق على جميع التطبيقات المستهدفة؛ وإلا فعلى الأهداف المحددة صراحة فقط.
