...
Installer 安装完整 KernelSU/APatch/Magisk 模块，包括 service、native payload、scripts、policy、metadata 与 integrity records。支持 Android 12-17、ARM64、x86 64；三者均提供完整 WebUI 支持，Magisk 上通过模块 Action 按钮经由独立 WebUI 宿主应用打开 WebUI（详见 [Magisk 支持](Magisk.md)）。Recovery 安装途径会被拒绝。
