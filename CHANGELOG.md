...
- **Stronger protection and checks:** sensitive backup material is cleaned up sooner, encryption dependencies are updated, and native/Rust checks cover integration changes more reliably.
