...
- **WebUI & Mobile Usability:** Improved readability with a 17px base font and responsive mobile layouts, refined touch targets, fixed translation fallbacks (`noServers` / server lists), and added automatic system and browser locale detection across all supported languages.
