...
/** Test-only managed oracle for differential CBOX compatibility checks. */
internal object ManagedCboxCryptoOracle {
    ...
    fun verifySignature(
        ...
        return try {
            val decodedPublicKey = Base64.getDecoder().decode(publicKeyBase64)
            ...
            val decodedSignature = Base64.getDecoder().decode(payload.signatureBase64)
