...
/** Test-only managed oracle retained for Rust CTSB differential compatibility checks. */
internal object ManagedBackupCryptoOracle {
    private const val MAGIC = "CTSB"
