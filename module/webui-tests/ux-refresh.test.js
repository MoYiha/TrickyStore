...
assert.ok(chips && !chips.hidden, 'system/user filter must appear once flags are known');
...
assert.ok(manyChips && !manyChips.hidden, 'filters must appear once flags resolve');
