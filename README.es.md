...
CleveresTricky es un módulo para KernelSU, APatch y Magisk en Android 12-17. Reúne compatibilidad con Android Keystore y attestation, gestión de Keybox/CBOX, selección de aplicaciones, controles opcionales de identidad, niveles de parche y herramientas de privacidad en una sola WebUI móvil.
...
- Crear copias de seguridad, revisar el estado efectivo y recopilar diagnósticos desde la página Logs de la WebUI o ejecutando `/data/adb/modules/cleverestricky/emergency-report.sh`.
...
2. Instala el ZIP desde KernelSU, APatch o Magisk mientras Android está en funcionamiento.
3. Abre la WebUI de CleveresTricky desde tu gestor de módulos (en Magisk, desde el botón Action del módulo).
...
Usa la página **Logs** de la WebUI o ejecuta `/data/adb/modules/cleverestricky/emergency-report.sh` para crear un informe de diagnóstico de emergencia. Revisa el archivo antes de compartirlo, ya que puede contener información del dispositivo y del sistema.
